...
//        $data = $this->data;
        if ($data['result_code'] == 'SUCCESS') {
            ...
            //开启事务，事务有不同的锁机制https://www.jianshu.com/p/4e3edbedb9a8
            //用的不多按照TP文档操作就可以https://www.kancloud.cn/manual/thinkphp5/139063
            Db::startTrans();
            try {
                //根据订单号去获取订单的id，行锁，表锁？？不懂
    ...
    {
//        $pIDs = array_keys($status['pStatus']);//能不能批量减库存？？
